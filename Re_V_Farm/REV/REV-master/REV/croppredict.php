...
<html>
<head>
<title>REV:REVOLUTION WE BRING TO FARMING </title>
        ...
        <div class="row">
			<div class="container-fluid">
				   ...
				   # $season='Rabi';
                    ...
                    $command = escapeshellcmd("C:\Users\Shailendra\rev\ZDecision_Tree_Model_Call.py $JsonState $JsonDistrict $JsonSeason");
                    $output = shell_exec($command);
					echo $output;
					echo "<h3>Wheat||Sugarcane||Maize</h3>";
					}
                    ?>
					</h3>
            </div>
	...
	<div class="footer" style="position:absolute;width:100%; bottom:0;">
		<div class="container">
			<div class="copyright text-center">
				<p>&copy; Re_v_farm:Revolution we bring to farming </a></p>
			</div>
		</div>
	</div>
	<!-- footer-section -->
